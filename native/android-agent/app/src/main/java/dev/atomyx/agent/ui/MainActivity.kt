...
/**
 * Single-screen launcher for Atomyx.
 *
 *   1. Shows accessibility + usage-stats permission status
 *   2. Deep-links to Settings to grant missing permissions
 *   3. Starts the AtomyxForegroundService when everything is ready
 *
 * No recording, no app picker, no server URL. Atomyx is purely a control plane
 * for AI-driven exploratory testing — the host MCP client (Atomyx)
