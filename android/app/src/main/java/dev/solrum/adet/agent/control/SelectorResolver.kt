...
import dev.solrum.adet.agent.control.strategy.ContentDescStrategy
import dev.solrum.adet.agent.control.strategy.HintStrategy
import dev.solrum.adet.agent.control.strategy.ResolutionStrategy
import dev.solrum.adet.agent.control.strategy.ResourceIdStrategy
import dev.solrum.adet.agent.control.strategy.TextContainsStrategy
import dev.solrum.adet.agent.control.strategy.TextStrategy
