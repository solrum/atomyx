 ...
 *
 * When the Swift driver migrates to emit the canonical
 * `TreeNodeWire` shape directly, this normalizer shrinks to a
 * pass-through or goes away entirely. Until then, every field
 * below represents a legacy-to-canonical mapping decision.
 */
