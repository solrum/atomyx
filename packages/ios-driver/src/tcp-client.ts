 ...
 *
 * Pure transport. No selector resolution, scroll logic,
 * obscurement detection, or lifecycle juggling lives here — those
 * are core-framework concerns. The IosDriver class above calls
 * `.call(type, args)` and waits for the structured response;
