 ...
 *
 * Port of the legacy tool onto the new framework. Uses
 * Orchestra for the tap + hierarchy polling, flattens
 * TreeNode snapshots into CompactElement lists, and on
 * timeout runs `classifyFailure` to get structured
 * diagnostics the agent can react to.
 */
