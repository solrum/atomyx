/**
 * @atomyx/core-driver-wire — canonical HTTP+JSON wire contract between
 ...
 * live in `@atomyx/core-driver-{android,ios}` packages that consume this schema.
 *
 * Downstream dependency direction:
 *
 *   @atomyx/core-driver-wire  (this)
 *        ↑       ↑
